...
# Message the user
message "Hi @#{pr_author} thank you for your submission at Fossasia's GCI 2017 website. Please correct any issues above, if any."

# include link unless provided.
markdown ":link: Maintainers: @#{pr_author} did not provide a live link, one can be found at https://#{pr_author}.github.io/gci17.fossasia.org" unless github.pr_body.include? 'http'
